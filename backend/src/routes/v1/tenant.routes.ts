...
import {
  ...
  getMyTenantHistory,
  getMyTenantProfile,
  patchMyEmergencyContact,
  patchMyTenantProfile,
  postMyDocument,
  postMyEmergencyContact,
  postMyKycSubmit,
} from "../../modules/tenant-mgmt/tenant-portal.controller.js";
import {
...
import {
  getMyMaintenanceAttachmentSignedUrl,
  getMyMaintenanceTicket,
  getMyMaintenanceTimeline,
  listMyMaintenanceTicketsHandler,
  postMyMaintenanceAttachment,
  postMyMaintenanceMessage,
  postMyMaintenanceRating,
  postMyMaintenanceTicket,
} from "../../modules/maintenance/maintenance-tenant.controller.js";
...
tenantRouter.patch(
  "/me/profile",
  validateBody(updateTenantProfileDto),
  patchMyTenantProfile,
);
...
tenantRouter.post(
  ...
  validateBody(createEmergencyContactDto),
  postMyEmergencyContact,
);

tenantRouter.patch(
  "/me/emergency-contacts/:contactId",
  validateBody(updateEmergencyContactDto),
  patchMyEmergencyContact,
);
...
tenantRouter.post(
  "/me/maintenance/tickets",
  validateBody(createMaintenanceTicketDto),
  postMyMaintenanceTicket,
);
...
tenantRouter.post(
  "/me/maintenance/tickets/:ticketId/messages",
  validateBody(addMaintenanceMessageDto),
  postMyMaintenanceMessage,
);

tenantRouter.post(
  "/me/maintenance/tickets/:ticketId/attachments",
  upload.single("file"),
  postMyMaintenanceAttachment,
);

tenantRouter.post(
  "/me/maintenance/tickets/:ticketId/rate",
  validateBody(submitMaintenanceRatingDto),
  postMyMaintenanceRating,
);

tenantRouter.get(
  "/me/maintenance/tickets/:ticketId/attachments/:attachmentId/signed-url",
  getMyMaintenanceAttachmentSignedUrl,
);
