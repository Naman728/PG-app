...
import { BedStatus, OrgRole, TenantLifecycleStatus, UserRole, } from "@prisma/client";
...
async function ensureDemoProperty(organizationId) {
...
async function ensureDemoTenantUser(organizationId, tenantPhone) {
...
async function seedEmailOwner(orgName) {
...
async function seedPhoneOwner(orgName, ownerPhone) {
...
async function main() {
    ...
    let organizationId;
    let ownerPhoneForTenantCompare;
    if (ownerEmail && ownerPassword) {
        ...
        console.log("Skip seed: set SEED_OWNER_EMAIL + SEED_OWNER_PASSWORD, or SEED_OWNER_PHONE (+E.164).");
        return;
    }
