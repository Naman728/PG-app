...
import { drainNotificationQueue, reclaimStaleProcessingJobs, } from "../modules/rent/notification-queue.service.js";
import { generateCurrentMonthForAllOrgs, markOverdueInvoicesGlobally, runRentReminderSweepAllOrgs, } from "../modules/rent/rent.service.js";
let started = false;
...
async function monthlyGeneration() {
    try {
...
export function registerRentCronJobs() {
    if (started)
        return;
...
//# sourceMappingURL=rent-cron.js.map